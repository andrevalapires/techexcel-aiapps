...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Gets all bookings for a hotel after a specific date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, 
        [Description("The minimum date to get the hotel bookings")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all the bookings that are not assigned to hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Get all the bookings assigned to multiple hotel rooms.")]
